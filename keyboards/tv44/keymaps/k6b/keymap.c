...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_L3] = { /* LAYER 3 - LOCK */
    {_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, KC_PPLS, KC_P7,   KC_P8,   KC_P9,   KC_P0,   _______ },
    {_______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, KC_PMNS, KC_P4,   KC_P5,   KC_P6,   KC_PEQL, _______ },
    {_______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSLS, KC_PAST, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______ },
